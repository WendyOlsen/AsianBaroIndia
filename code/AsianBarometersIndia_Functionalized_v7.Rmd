...
First Arthur: Ziyang Zhou <br>
Second Arthur: Prof. Wendy Olsen <br>
Affiliation: Department of Social Statistics, University of Manchester <br>
The license is Creative Commons, so please use it and cite this work as Wendy Olsen and Ziyang Zhou. Creative Commons, University of Manchester, 2024.
...
## Read data
Note: before running this code, set the working directory to the folder that contains you data or change the filepath to your data file's path.
```{r}
...
```
Example of using the function and then calculate its entropy:
```{r}
q63_encoded <- Likert_Encoder(q63)

print("The likert matrix for Quesiton 63 is (first 10 rows): ")
